...
const APP_CONFIG = {
  ...
  ALIYUN: {
    ALIBABA_CLOUD_ENDPOINT: getConfig(ENV_VARIABLE.ALIBABA_CLOUD_ENDPOINT),
    ALIBABA_CLOUD_ACCESS_KEY_ID: getConfig(
      ENV_VARIABLE.ALIBABA_CLOUD_ACCESS_KEY_ID,
    ),
    ALIBABA_CLOUD_ACCESS_KEY_SECRET: getConfig(
      ENV_VARIABLE.ALIBABA_CLOUD_ACCESS_KEY_SECRET,
    ),
    ALIBABA_CLOUD_STS_ENDPOINT: getConfig(
      ENV_VARIABLE.ALIBABA_CLOUD_STS_ENDPOINT,
    ),
    ALIBABA_CLOUD_STS_ACCESS_KEY_ID: getConfig(
      ENV_VARIABLE.ALIBABA_CLOUD_STS_ACCESS_KEY_ID,
    ),
    ALIBABA_CLOUD_STS_ACCESS_KEY_SECRET: getConfig(
      ENV_VARIABLE.ALIBABA_CLOUD_STS_ACCESS_KEY_SECRET,
    ),
    ALIBABA_BAILIAN_API_KEY: getConfig(ENV_VARIABLE.ALIBABA_BAILIAN_API_KEY),
  },
};
